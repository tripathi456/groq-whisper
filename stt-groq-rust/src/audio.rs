...
impl AudioRecorder {
    ...
    pub fn start_recording(&mut self) -> Result<()> {
        ...
        // Clone the sender to move into the audio callback.
    ...
    ///
    /// Dropping the sender and stream stops further sample collection.
    pub fn stop_recording(&mut self) {
        self.samples_tx = None; // Dropping the sender will eventually close the channel.
        self.stream = None;
